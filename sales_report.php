            ...
            <div class = "panel-heading">
              ...
              <?php
                ...
                if (isset($_POST['generate'])) {
                   $query = "SELECT * FROM transaction  LEFT JOIN `order` ON order.order_id = transaction.order_id LEFT JOIN customer ON customer.customer_id = order.customer_id WHERE transaction_date BETWEEN '$start' AND '$end'";
